...
var ScheduleCard = function ScheduleCard(props) {
  ...
  return React.createElement("div", {
    ...
    src: img,
    alt: title || '日程'
  }), React.createElement("span", null, title || '这是标题')), showData && showData.map(function (item, index) {
    return React.createElement("div", {
      ...
      alt: '主题'
    })), React.createElement("span", null, item.title), React.createElement("span", null, item.text));
  })));
};

export { ScheduleCard, TextCard };
