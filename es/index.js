    ...
    return (React.createElement("div", { className: `${size ? `robot-list-${size}` : 'robot-list-default'} ` },
        ...
        React.createElement("div", { className: 'robot-list-card', style: { width: width ? `${width}px` : '260px' } },
            ...
            React.createElement("div", { className: 'robot-list-body' }, type === 'radio' ?
                React.createElement(RadioGroup, { onChange: (value) => onRadioChange(value) }, listData && listData.map((item, index) => {
                    if (index < row) {
                        return React.createElement(Radio, { key: item.value, value: item.value, className: 'robot-list-option' }, item.label);
                    }
                }))
                :
                    React.createElement(CheckboxGroup, { onChange: (value) => onCheckboxChange(value) }, listData && listData.map((item, index) => {
                        if (index < row) {
