...
var TextCard = function TextCard(props) {
  ...
  if (link) {
    return React__default['default'].createElement("div", {
      className: "robot-text-wrapper ".concat(type ? "robot-text-".concat(type) : 'robot-text-defalut', " ")
  ...
  return React__default['default'].createElement("div", {
    className: "robot-text-wrapper ".concat(type ? "robot-text-".concat(type) : 'robot-text-default', " ")
  }, text);
};
...
var ScheduleCard = function ScheduleCard(props) {
  var title = props.title,
      text = props.text,
      showData = props.showData,
      type = props.type;
  return React__default['default'].createElement("div", {
    className: "robot-schedule-wrapper ".concat(type ? "robot-schedule-".concat(type) : 'robot-schedule-default', " ")
  }, React__default['default'].createElement(TextCard, {
    text: text,
    type: type ? type : 'default'
  }), React__default['default'].createElement("div", {
    className: 'robot-schedule-card',
    style: {
      width: '260px'
    }
  }, React__default['default'].createElement("div", {
    className: 'robot-schedule-header'
  }, React__default['default'].createElement("img", {
    src: img,
    alt: title || '日程'
  }), React__default['default'].createElement("span", null, title || '这是标题')), showData && showData.map(function (item, index) {
    return React__default['default'].createElement("div", {
      className: 'robot-schedule-item',
      key: index
    }, React__default['default'].createElement("span", null, React__default['default'].createElement("img", {
      src: item.img || 'https://iuap-aiplatform-picdoc.oss-cn-beijing.aliyuncs.com/webrobotresource/img/topic.svg',
      alt: '主题'
    })), React__default['default'].createElement("span", null, item.title), React__default['default'].createElement("span", null, item.text));
  })));
};
