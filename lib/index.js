    ...
    return (React__default['default'].createElement("div", { className: `${size ? `robot-list-${size}` : 'robot-list-default'} ` },
        ...
        React__default['default'].createElement("div", { className: 'robot-list-card', style: { width: width ? `${width}px` : '260px' } },
            ...
            React__default['default'].createElement("div", { className: 'robot-list-body' }, type === 'radio' ?
                React__default['default'].createElement(RadioGroup, { name: "listRadio", onChange: (value) => onRadioChange(value) }, listData && listData.map((item, index) => {
                    if (index < row) {
                        return React__default['default'].createElement(Radio, { value: item.value, className: 'robot-list-option' }, item.label);
                    }
                }))
                :
                    React__default['default'].createElement(CheckboxGroup, { name: "listCheckbox", onChange: (value) => onCheckboxChange(value) }, listData && listData.map((item, index) => {
                        if (index < row) {
                            return React__default['default'].createElement(Checkbox, { value: item.value, className: 'robot-list-option' }, item.label);
                        }
                    }))),
